...
Experienced Full Stack Developer with over 12 years in creating secure and scalable mobile and web applications across domains like banking and e-learning. Proficient in team leadership, project delivery, and working with technologies such as React Native, Ionic, Angular, Spring Boot, and NodeJS. Seeking to bring expertise to a collaborative team and drive impactful results.
...
*   Designed the user interface of a mobile application for a financial organization in Bangkok using AngularJS and Ionic.
*   Performed unit testing and sprint planning.
...
*   Executed project and sprint planning.

**Senior Software Developer**  
_October 2017 – September 2018 (1 year)_

*   Created an in-house product, Compaz, dealing with customer behavior analysis using NodeJS, MongoDB, and ReactJS.
...
*   Supervised project and sprint planning.

**Hybrid Mobile Application Developer**  
_May 2015 – April 2016 (1 year)_

*   Built hybrid mobile applications with IBM Mobile First (Worklight) and Sencha Touch.
...
*   Implimented the iPad applications in Objective C, including Cordiant's first Apple Store application.
